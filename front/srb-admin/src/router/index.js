...
export const constantRoutes = [{
  ...
  },
  {
    ...
    alwaysShow: true, //当且仅当父节点下只有一个子节点时，不显示父节点 false  true: 任何时候都显示父节点和子节点
    //每个路由节点的name 不能相同
    children: [{
        path: 'list', //真正的路由地址
        ...
        //指向template模板组件
        component: () =>
          import ('@/views/core/integral-grade/list'),
      ...
      },
      {
        ...
        component: () =>
          import ('@/views/core/integral-grade/form'),
        meta: { title: '新增积分等级' }
      },
      {
        path: 'edit/:id', //:id 是一个占位符 表示这部分的url会是任何一个id
  ...
  },
  {
    ...
    children: [{
      ...
      component: () =>
        import ('@/views/core/user-info/list'),
      meta: { title: '会员列表' }
    }]
  },
  {
    ...
    children: [{
        ...
        component: () =>
          import ('@/views/core/borrower/list'),
        meta: { title: '借款人列表' }
      },
      {
        path: 'detail/:id',
        ...
        component: () =>
          import ('@/views/core/borrower/detail'),
        meta: { title: '借款人详情' },
        hidden: true
      },
      {
        ...
        component: () =>
          import ('@/views/core/borrow-info/list'),
        meta: { title: '借款列表' }
      },
      {
        path: 'info-detail/:id',
        ...
        component: () =>
          import ('@/views/core/borrow-info/detail'),
        meta: { title: '借款详情' },
        hidden: true
      }
    ]
